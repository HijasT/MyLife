  ...
  return (
    <div className="mx-3 mb-3 px-3 py-2.5 rounded-lg border border-sidebar-border bg-sidebar-hover">
      <div className="flex items-center gap-2 mb-1">
        ...
        <span className="text-xs font-semibold" style={{ color: isOnline ? "#4ade80" : "#fbbf24" }}>
          {isOnline ? "Online" : "Offline"}
        </span>
      </div>
      <div className="flex items-center gap-1.5">
        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-sidebar-text flex-shrink-0">
    ...
    <aside className={clsx("fixed left-0 top-0 h-full w-[240px] bg-sidebar flex flex-col border-r border-sidebar-border z-50 transition-transform duration-300 ease-in-out lg:translate-x-0", isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0")}>
      ...
      <div className="px-5 py-5 border-b border-sidebar-border flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <button onClick={close} className="lg:hidden w-8 h-8 rounded-lg flex items-center justify-center text-sidebar-text hover:text-white hover:bg-sidebar-hover transition-all">
            <CloseIcon />
          </button>
        </div>
      </div>
